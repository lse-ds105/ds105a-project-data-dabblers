...
[Scroll horizontally to view full plot, click here to view in separate window](lda_visualisations.html){target="_blank" rel="noopener"}

<iframe src="lda_visualisation.html" width="100%" height="1000px"></iframe>
